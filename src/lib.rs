...
//! | [`ASTROSIL`]             | $\mathrm{MgFeSiO_4}$               | Mixed                     |       3.3                                |        $6\times 10^-5$     |         $1 \times 10^5$    | [Draine+03](https://ui.adsabs.harvard.edu/abs/2003ApJ...598.1017D)
...
//! | [`C_NANO`]               | $\mathrm{C}$ nano-diamond          | Crystalline               |       2.3                                |        0.02                |       110                  | [Mutschke+04](https://ui.adsabs.harvard.edu/abs/2004A%26A...423..983M)   
